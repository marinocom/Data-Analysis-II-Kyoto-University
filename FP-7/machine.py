...
# Utility Functions
def display_title(s, pref='Analysis', num=1):
...
def analyze_feature_importance(df, n_top_features=10):
    ...
    """
    display_title('Feature Engineering & Importance Analysis', num=1)
...
def compare_models_with_cv(df, cv_folds=5):
    ...
    """
    display_title('Model Comparison with Cross-Validation', num=2)
